...
btnRow.addEventListener("click", (event) => {
  ...
  btnRow.classList.add("nav__btn--active");
...
btnRowReverse.addEventListener("click", (event) => {
  ...
  btnRowReverse.classList.add("nav__btn--active");
...
btnColumn.addEventListener("click", (event) => {
  ...
  btnColumn.classList.add("nav__btn--active");
...
btnColumnReverse.addEventListener("click", (event) => {
  ...
  btnColumnReverse.classList.add("nav__btn--active");
...
btnColumnGap.addEventListener("click", (event) => {
  ...
  btnColumnGap.classList.add("nav__btn--active");
...
btnRowGap.addEventListener("click", (event) => {
  ...
  btnRowGap.classList.add("nav__btn--active");
...
btnGap.addEventListener("click", (event) => {
  ...
  btnGap.classList.add("nav__btn--active");
...
btnNoGap.addEventListener("click", (event) => {
  ...
  btnNoGap.classList.add("nav__btn--active");
...
btnAcStart.addEventListener("click", (event) => {
  ...
  btnAcStart.classList.add("nav__btn--active");
...
btnAcCenter.addEventListener("click", (event) => {
  ...
  btnAcCenter.classList.add("nav__btn--active");
...
btnAcEnd.addEventListener("click", (event) => {
  ...
  btnAcEnd.classList.add("nav__btn--active");
...
btnAcBetween.addEventListener("click", (event) => {
  ...
  btnAcBetween.classList.add("nav__btn--active");
...
btnAcAround.addEventListener("click", (event) => {
  ...
  btnAcAround.classList.add("nav__btn--active");
...
btnJcStart.addEventListener("click", (event) => {
  ...
  [
    ...
    btnJcAround,
    btnJcEvenly
  ].forEach((btn) => btn.classList.remove("nav__btn--active"));
  btnJcStart.classList.add("nav__btn--active");
...
btnJcCenter.addEventListener("click", (event) => {
  ...
  btnJcCenter.classList.add("nav__btn--active");
...
btnJcEnd.addEventListener("click", (event) => {
  ...
  btnJcEnd.classList.add("nav__btn--active");
...
btnJcBetween.addEventListener("click", (event) => {
  ...
  btnJcBetween.classList.add("nav__btn--active");
...
btnJcAround.addEventListener("click", (event) => {
  ...
  btnJcAround.classList.add("nav__btn--active");
...
btnJcEvenly.addEventListener("click", (event) => {
  ...
  btnJcEvenly.classList.add("nav__btn--active");
